...
public class ComponentPO implements java.io.Serializable {

	private static final long serialVersionUID = 4589467591514094803L;
	...
	public void setAudt(String audt) {
		this.audt = audt;
	}
	...
	public String toJson() {
		...
		Gson gson = new GsonBuilder().setDateFormat(DateUtil.PATTERN_DATETIME)
				.create();
