...
import com.cfets.ts.s.task.core.ActorContext;
...
//		ActorContext.get().init();
//		TaskProvider.get().invoke(g1, new TaskRequestEvent("测试执行计划1", "WELL DONE"));

	}

	public static void main(String[] args) {
		new InvokeTest().testTaskList();
	}
